...
public class Main {
    public static void main(String[] args) {
        ...
        empleados.add(new Empleado("Pedro", LocalDate.of(2021, 7, 22), null)); // Temporariamente sin departamento
        empleados.add(new Empleado("paula", LocalDate.of(2006, 9, 10), null)); // Temporariamente sin departamento
